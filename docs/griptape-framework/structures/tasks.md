...
A [Task](../../reference/griptape/tasks/index.md) is a purpose-built objective for the Language Model (LLM). Griptape offers various types of Tasks, each suitable for specific use cases.
